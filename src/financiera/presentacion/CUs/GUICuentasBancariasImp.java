...
public class GUICuentasBancariasImp extends GUICuentasBancarias{
	...
	String funcButtonName = "Crear cuenta"; //El texto que sale en el botón de la función
	String[] columnas = {"ID", "Nombre", "IBAN", "Banco", "Saldo"}; 
	String tituloTabla = "Cuentas bancarias"; 
	String tituloPanel = "CUENTAS BANCARIAS";
	int eventoFunc = Eventos.AÑADIR_CUENTA; //Tenéis que añadir el vuestro a la clase Eventos y al Controlador
