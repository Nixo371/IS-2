...
public class GUILlegaVehiculoImp extends GUILlegaVehiculo {
	...
	//---------------------------------
	String funcButtonName = "Llega Vehículo"; //El texto que sale en el botón de la función
	String[] columnas = {"Número plaza", "Estado"}; //Estado: disponible, reservada, en mantenimiento
	String tituloTabla = "Información Plazas Disponibles"; 
	String tituloPanel = "Llega Vehículo";
	int eventoFunc = Eventos.LLEGA_VEHICULO; //Tenéis que añadir el vuestro a la clase Eventos y al Controlador
	//String descFunc = "Se modificará la plaza"; //Mensaje por defecto hasta implementar funcionalidad real
	//---------------------------------
