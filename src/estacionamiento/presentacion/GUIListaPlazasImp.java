...
public class GUIListaPlazasImp extends GUIListaPlazas {
	...
	//---------------------------------
	String funcButtonName = "Lista Plazas"; //El texto que sale en el botón de la función
	String[] columnas = {"Número plaza", "Estado"}; //Estado: disponible, reservada, en mantenimiento
	String tituloTabla = "Información Plazas"; 
	String tituloPanel = "Lista Plazas";
	int eventoFunc = Eventos.LISTA_PLAZAS; //Tenéis que añadir el vuestro a la clase Eventos y al Controlador
