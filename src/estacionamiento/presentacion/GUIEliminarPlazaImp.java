...
public class GUIEliminarPlazaImp extends GUIEliminarPlaza {
	...
	String tituloPanel = "Eliminar Plaza";
	int eventoFunc = Eventos.ELIMINAR_PLAZA; //Tenéis que añadir el vuestro a la clase Eventos y al Controlador
	String descFunc = "Se eliminará la plaza"; //Mensaje por defecto hasta implementar funcionalidad real
	//---------------------------------
