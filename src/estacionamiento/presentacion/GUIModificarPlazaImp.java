...
public class GUIModificarPlazaImp extends GUIModificarPlaza {
	...
	//---------------------------------
	String funcButtonName = "Modificar"; //El texto que sale en el botón de la función
	String[] columnas = {"Número plaza", "Estado"}; //Estado: disponible, reservada, en mantenimiento
	String tituloTabla = "Información Plazas"; 
	String tituloPanel = "Modificar Plaza";
	int eventoFunc = Eventos.MODIFICAR_PLAZA; //Tenéis que añadir el vuestro a la clase Eventos y al Controlador
