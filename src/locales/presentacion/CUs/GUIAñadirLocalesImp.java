...
public class GUIAñadirLocalesImp extends GUIAñadirLocales {
	
	//Esto es lo que tenéis que cambiar (y el nombre de la clase)
	//---------------------------------
	String funcButtonName = "Añadir"; //El texto que sale en el botón de la función
	String[] columnas = {"IDLocal", "Empresa", "Ingresos", "Gastos", "Fecha contrato"}; 
	String tituloTabla = "Información Local"; 
	String tituloPanel = "Añadir Locales";
	int eventoFunc = Eventos.AÑADIR_LOCALES; //Tenéis que añadir el vuestro a la clase Eventos y al Controlador
