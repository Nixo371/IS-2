...
public class GUIMostrarLocalesImp extends GUIMostrarLocales {
	...
	int eventoFunc = Eventos.MOSTRAR_LOCALES; //Tenéis que añadir el vuestro a la clase Eventos y al Controlador
	String descFunc = "Se Mostrarán los datos"; //Mensaje por defecto hasta implementar funcionalidad real
	//---------------------------------
