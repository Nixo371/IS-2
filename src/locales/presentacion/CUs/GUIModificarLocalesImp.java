...
public class GUIModificarLocalesImp extends GUIModificarLocales {
	...
	int eventoFunc = Eventos.MODIFICAR_LOCALES; //Tenéis que añadir el vuestro a la clase Eventos y al Controlador
	String descFunc = "Se Modificarán los datos"; //Mensaje por defecto hasta implementar funcionalidad real
	//---------------------------------
