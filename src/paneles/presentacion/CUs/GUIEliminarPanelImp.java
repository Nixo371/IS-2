...
public class GUIEliminarPanelImp extends GUIEliminarPanel {
	...
	String tituloPanel = "Eliminar Panel";
	int eventoFunc = Eventos.ELIMINAR_PANEL; //Tenéis que añadir el vuestro a la clase Eventos
	String descFunc = "Se eliminará el panel"; //Mensaje por defecto hasta implementar funcionalidad real
	//---------------------------------
