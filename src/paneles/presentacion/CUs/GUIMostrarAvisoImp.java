...
public class GUIMostrarAvisoImp extends GUIMostrarAviso {
	
	//Esto es lo que tenéis que cambiar (y el nombre de la clase)
	//---------------------------------
	String funcButtonName = "Mostrar"; //El texto que sale en el botón de la función
	String[] columnas = {"ID", "Origen", "Llegada", "..."}; 
	String tituloTabla = "Información Paneles"; 
	String tituloPanel = "Mostrar Aviso";
	int eventoFunc = Eventos.MOSTRAR_AVISO; //Tenéis que añadir el vuestro a la clase Eventos
	String descFunc = "Se mostrará el aviso"; //Mensaje por defecto hasta implementar funcionalidad real
	//---------------------------------
