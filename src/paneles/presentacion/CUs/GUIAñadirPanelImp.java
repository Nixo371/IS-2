...
public class GUIAñadirPanelImp extends GUIAñadirPanel {
	...
	int eventoFunc = Eventos.AÑADIR_PANEL; //Tenéis que añadir el vuestro a la clase Eventos
	String descFunc = "Se añadirá el panel"; //Mensaje por defecto hasta implementar funcionalidad real
	//---------------------------------
