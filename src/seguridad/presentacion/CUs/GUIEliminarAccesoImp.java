...
public class GUIEliminarAccesoImp extends GUIEliminarAcceso {
    ...
    String funcButtonName = "Eliminar Acceso";
    String[] columnas = {"ID", "Usuario", "Zona", "Duración", "Estado"};
    String tituloTabla = "Información de Accesos";
    String tituloPanel = "Eliminar Acceso a Zona Restringida";
    int eventoFunc = Eventos.ELIMINAR_ACCESO;
    String descFunc = "Se eliminará el acceso a la zona restringida para el usuario seleccionado";
