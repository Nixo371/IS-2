...
public class GUIConfigurarDispositivoImp extends GUIConfigurarDispositivo {
    ...
    String funcButtonName = "Configurar Dispositivo";
    String[] columnas = {"ID", "Nombre", "Parámetro", "Valor Actual"};
    String tituloTabla = "Lista de Dispositivos Configurables";
    String tituloPanel = "Configurar Dispositivo de Seguridad";
    int eventoFunc = Eventos.CONFIGURAR_DISPOSITIVO;
    String descFunc = "Se configurará el dispositivo de seguridad seleccionado";
