...
public class GUIVerificarAccesoImp extends GUIVerificarAcceso {
    ...
    // Adaptación para el caso de uso "Verificar Acceso a Zona Restringida"
    //---------------------------------
    String funcButtonName = "Verificar Acceso"; // Texto del botón de la función
    String[] columnas = {"ID", "Usuario", "Zona", "Duración", "Estado"};
    String tituloTabla = "Información de Accesos";
    String tituloPanel = "Verificar Acceso a Zona Restringida";
    int eventoFunc = Eventos.VERIFICAR_ACCESO;
    String descFunc = "Se verificará el acceso a la zona restringida para el usuario seleccionado";
    //---------------------------------
