...
public class GUIDesactivarDispositivoImp extends GUIDesactivarDispositivo {
    ...
    String funcButtonName = "Desactivar Dispositivo";
    String[] columnas = {"ID", "Nombre", "Tipo", "Estado"};
    String tituloTabla = "Lista de Dispositivos de Seguridad";
    String tituloPanel = "Desactivar Dispositivo de Seguridad";
    int eventoFunc = Eventos.DESACTIVAR_DISPOSITIVO;
    String descFunc = "Se desactivará el dispositivo de seguridad seleccionado";
